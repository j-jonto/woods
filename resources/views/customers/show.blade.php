...
<a href="{{ route('customers.add_payment', $customer) }}" class="btn btn-success mb-3">إضافة إيصال قبض</a>
...
@php
    ...
    foreach($customer->salesOrders as $order) {
        $movements[] = [
            ...
            'desc' => 'فاتورة مبيعات رقم ' . $order->order_no,
